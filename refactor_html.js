...
// Remove syntax, flagged, location fields
const fieldsRegex = /<div class="meta-field syntax-field">[\s\S]*?<span class="meta-sep" aria-hidden="true"><\/span>\s*<label class="meta-field location-field" title="Attach location">[\s\S]*?<\/label>/;
html = html.replace(fieldsRegex, '');
...
const newFooterNav = `<nav class="footer-nav">$1\n                <span class="footer-sep">·</span>\n                <button type="button" id="change-address-btn" class="btn-sign-out">Change Address</button>\n            </nav>`;
// Also remove old sign-out-btn and its separator
